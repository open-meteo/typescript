...
export class WeatherApi {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):WeatherApi {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsWeatherApi(bb:flatbuffers.ByteBuffer, obj?:WeatherApi):WeatherApi {
  return (obj || new WeatherApi()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsWeatherApi(bb:flatbuffers.ByteBuffer, obj?:WeatherApi):WeatherApi {
...
model():WeatherModel {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : WeatherModel.undefined;
}
...
daily(obj?:WeatherDaily):WeatherDaily|null {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? (obj || new WeatherDaily()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

hourly(obj?:WeatherHourly):WeatherHourly|null {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? (obj || new WeatherHourly()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

sixHourly(obj?:WeatherHourly):WeatherHourly|null {
  const offset = this.bb!.__offset(this.bb_pos, 24);
  return offset ? (obj || new WeatherHourly()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

minutely15(obj?:WeatherHourly):WeatherHourly|null {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? (obj || new WeatherHourly()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

current(obj?:WeatherCurrent):WeatherCurrent|null {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? (obj || new WeatherCurrent()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

static startWeatherApi(builder:flatbuffers.Builder) {
...
static addModel(builder:flatbuffers.Builder, model:WeatherModel) {
  builder.addFieldInt8(3, model, WeatherModel.undefined);
}
...
static addMinutely15(builder:flatbuffers.Builder, minutely15Offset:flatbuffers.Offset) {
  builder.addFieldOffset(11, minutely15Offset, 0);
}

static addCurrent(builder:flatbuffers.Builder, currentOffset:flatbuffers.Offset) {
  builder.addFieldOffset(12, currentOffset, 0);
}

static endWeatherApi(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishWeatherApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedWeatherApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
