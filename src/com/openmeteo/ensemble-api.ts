...
export class EnsembleApi {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EnsembleApi {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEnsembleApi(bb:flatbuffers.ByteBuffer, obj?:EnsembleApi):EnsembleApi {
  return (obj || new EnsembleApi()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEnsembleApi(bb:flatbuffers.ByteBuffer, obj?:EnsembleApi):EnsembleApi {
...
static startEnsembleApi(builder:flatbuffers.Builder) {
...
static endEnsembleApi(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEnsembleApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedEnsembleApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
