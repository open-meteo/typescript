...
export class AirQualityApi {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirQualityApi {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirQualityApi(bb:flatbuffers.ByteBuffer, obj?:AirQualityApi):AirQualityApi {
  return (obj || new AirQualityApi()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirQualityApi(bb:flatbuffers.ByteBuffer, obj?:AirQualityApi):AirQualityApi {
...
static startAirQualityApi(builder:flatbuffers.Builder) {
...
static endAirQualityApi(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirQualityApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset);
}

static finishSizePrefixedAirQualityApiBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
